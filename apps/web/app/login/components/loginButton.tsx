...
export default function LoginButton() {
  ...
  return (
    <Link
      href={`https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=2007625456&redirect_uri=http://localhost:3000/api/auth/line/login&state=${uuid}&scope=profile%20openid&nonce=09876xyz`}
