...
const buttonVariants = cva(
  'flex items-center transition-colors duration-300 justify-center font-bold disabled:bg-gray-200 disabled:text-gray-500 cursor-pointer grow disabled:border-none disabled:cursor-default',
  {
    variants: {
      variant: {
        filled: '',
